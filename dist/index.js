...
exports.getAdrIssues = getAdrIssues;
function getAdrIssuesForRepo(octokit, owner, repo, labels, statusRegex) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = yield octokit.paginate(
        ...
        yield Promise.all(data.map((issue) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (status !== undefined) {
                adrFromIssues.push({
                    ...
                    status,
                    author: (_d = (_c = issue.user) === null || _c === void 0 ? void 0 : _c.login) !== null && _d !== void 0 ? _d : '',
                    updateAt: extractDateFromISO8601(issue.updated_at)
                });
                return;
            }
            const adrs = yield getAdrComments(octokit, owner, repo, issue.number, statusRegex);
...
function getAdrComments(octokit, owner, repo, issueNumber, statusRegex) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = yield octokit.paginate(octokit.rest.issues.listComments.endpoint.merge({
            owner,
            repo,
        ...
        return data.map(comment => {
            ...
            return ({
                ...
                status: (_d = (_c = (_b = statusRegex
                    .exec((_a = comment.body) !== null && _a !== void 0 ? _a : '')) === null || _b === void 0 ? void 0 : _b.at(1)) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : 'unknown',
                author: (_f = (_e = comment.user) === null || _e === void 0 ? void 0 : _e.login) !== null && _f !== void 0 ? _f : '',
                updateAt: extractDateFromISO8601(comment.updated_at)
            });
        });
    });
}
function extractTitleFromComment(commentBody) {
    var _a, _b;
    ...
    const sentencesAfterTitle = (_a = new RegExp(/title[\s)\\n\\r]*(.+)/gim)
...
exports.outputADRsToDashboardIssue = outputADRsToDashboardIssue;
function formatADRIssuesToMarkdown(adrIssues) {
    ...
    for (const adrFromComment of adrIssues.adrFromComments) {
        ...
        adrPerIssueCommentText += (0, markdown_table_1.markdownTable)(adrPerCommentTable);
    }
    return `This issue was updated by aggregate-adr-issues action
## ADR per issue
${(0, markdown_table_1.markdownTable)(adrPerIssueTable)}

## ADR per issue comment
${adrPerIssueCommentText}
`;
}
function extractDateFromISO8601(iso8601) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initOctokit = void 0;
const rest_1 = __nccwpck_require__(5375);
const plugin_paginate_rest_1 = __nccwpck_require__(4193);
// Add the function of pagination to Octokit
const OctkitWithPagination = rest_1.Octokit.plugin(plugin_paginate_rest_1.paginateRest);
function initOctokit(auth) {
    return new OctkitWithPagination({ auth });
}
exports.initOctokit = initOctokit;
